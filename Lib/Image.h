...
public:
   ...
   //===========================================================================
   // Implemented by Md. Iftekhar Tanveer (go2chayan@gmail.com)
   // Constructor for loading from buffer
   Image (std::vector<unsigned char> pgmData){
	   LoadPgm(pgmData);
   }
   ...
   //===========================================================================
   // Implemented by Md. Iftekhar Tanveer (go2chayan@gmail.com)
   // Load the data directly from an array instead of reading
   // it from file
   void LoadPgm(std::vector<unsigned char> data){
